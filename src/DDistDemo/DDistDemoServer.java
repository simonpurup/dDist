...
public class DDistDemoServer {
    ...
    /** Method that allows for sending messages from the server to the client. This code is not pretty
     *  and should be refactored
     * @param socket The socket connected to the client.
     * @throws IOException
     */
    public void sendToClient(Socket socket) throws IOException {
