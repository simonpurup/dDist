...
public class DDistDemoClient {
    ...
    /** Method that allows for receiving messages sent from the server. This code is not pretty and should be refactored
     * @param socket The socket connected to the server
     * @throws IOException
     */
	public void readFromServer(Socket socket) throws IOException {
